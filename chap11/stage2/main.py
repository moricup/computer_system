...
def make_csv_of_SymbolTable(path_chap11, dir, jack_name, dict_class_symbolTable, dict_dict_method_symbolTable):
    # Make dir of SymbolTable
    path_to_SymbolTable = path_chap11 + dir + '/' + jack_name + '_SymbolTable'
...
def main():
    ...
    path_chap11 = json_data['path_chap11']
    ...
    for dir in list_dir:
        ...
        list_file_name = os.listdir(path_chap11 + dir)
        ...
        for jack_name in list_jack_name:
            ...
            with open(path_chap11 + dir + '/' + jack_name + '.jack', 'r') as jack:
            ...
            with open(path_chap11 + dir + '/' + jack_name + 'T_ans.xml', 'w') as xml_after_JackTokenizer:
            ...
            # Write *_ans.xml
            with open(path_chap11 + dir + '/' + jack_name + '_ans.xml', 'w') as xml:
            ...
            make_csv_of_SymbolTable(path_chap11, dir, jack_name, dict_class_symbolTable, dict_dict_method_symbolTable)

            # Generate VMWriter
            vmwriter = vmwriter_nand2tetris.VMWriter(dir, jack_name, list_row_xml, dict_class_symbolTable, dict_dict_method_symbolTable)

            # Get list_row_vm
            list_row_vm = vmwriter.output_list_row_vm()

            # Write *.vm
            with open(path_chap11 + dir + '/' + jack_name + '.vm', 'w') as vm:
                write_file_from_list_row_file(vm, list_row_vm)
